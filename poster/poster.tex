...
\usepackage[scale=.9]{beamerposter} % Use the beamerposter package for laying out the poster
\usepackage{tikz}
...
\AddToShipoutPictureFG{
  \AtPagemyUpperLeft{{\includegraphics[width=12cm,keepaspectratio]{bucknell.pdf}}}
}%
...
% \begin{column}{1ex}\end{column} % Empty spacer column
...
\begin{column}{.8\onecolwid}
  ...
  \end{alertblock}
\end{column}
\begin{column}{.05\onecolwid}\end{column} % Empty spacer column

% ----------------------------------------------------------------
\begin{column}{.3\onecolwid}\end{column} % Empty spacer column
...
\begin{column}{.35\onecolwid}\end{column} % Empty spacer column
...
\end{column}
% ----------------------------------------------------------------
\begin{column}{.4\onecolwid}\end{column} % Empty spacer column
\end{columns} % End of all the columns in the poster
\end{block}
\vspace{1ex}
